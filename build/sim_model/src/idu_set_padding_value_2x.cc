#include <pdp.h>
bool pdp::decode_pdp_set_padding_value_2x() {
auto local_var_1 = pdp_csb2pdp_addr.range(11, 0);
sc_biguint<12> local_var_2 = 72;
...
auto& univ_var_18 = local_var_15;
return univ_var_18;
}
void pdp::update_pdp_set_padding_value_2x() {
auto local_var_1 = pdp_csb2pdp_data.range(18, 0);
auto local_var_1_nxt_holder = local_var_1;
pdp_group0_pdp_d_pad_value_2x = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "set_padding_value_2x state updates:" << std::endl;
instr_update_log << "    pdp_group0_pdp_d_pad_value_2x => " << std::hex << "0x" << pdp_group0_pdp_d_pad_value_2x << std::endl; 
