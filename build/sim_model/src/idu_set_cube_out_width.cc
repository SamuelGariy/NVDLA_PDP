#include <pdp.h>
bool pdp::decode_pdp_set_cube_out_width() {
auto local_var_1 = pdp_csb2pdp_addr.range(11, 0);
sc_biguint<12> local_var_2 = 24;
...
auto& univ_var_6 = local_var_15;
return univ_var_6;
}
void pdp::update_pdp_set_cube_out_width() {
auto local_var_1 = pdp_csb2pdp_data.range(12, 0);
auto local_var_1_nxt_holder = local_var_1;
pdp_group0_pdp_d_cube_out_width = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "set_cube_out_width state updates:" << std::endl;
