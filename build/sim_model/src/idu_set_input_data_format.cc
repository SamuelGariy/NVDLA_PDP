#include <pdp.h>
bool pdp::decode_pdp_set_input_data_format() {
auto local_var_1 = pdp_csb2pdp_addr.range(11, 0);
sc_biguint<12> local_var_2 = 132;
...
auto& univ_var_33 = local_var_15;
return univ_var_33;
}
void pdp::update_pdp_set_input_data_format() {
auto local_var_1 = pdp_csb2pdp_data.range(1, 0);
auto local_var_1_nxt_holder = local_var_1;
pdp_group0_pdp_d_input_data = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "set_input_data_format state updates:" << std::endl;
instr_update_log << "    pdp_group0_pdp_d_input_data => " << std::hex << "0x" << pdp_group0_pdp_d_input_data << std::endl; 
