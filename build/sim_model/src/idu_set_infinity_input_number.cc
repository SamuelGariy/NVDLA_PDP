#include <pdp.h>
bool pdp::decode_pdp_set_infinity_input_number() {
auto local_var_1 = pdp_csb2pdp_addr.range(11, 0);
sc_biguint<12> local_var_2 = 136;
...
auto& univ_var_34 = local_var_15;
return univ_var_34;
}
void pdp::update_pdp_set_infinity_input_number() {
auto local_var_1 = pdp_csb2pdp_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
pdp_group0_pdp_d_inf_input_num = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "set_infinity_input_number state updates:" << std::endl;
instr_update_log << "    pdp_group0_pdp_d_inf_input_num => " << std::hex << "0x" << pdp_group0_pdp_d_inf_input_num << std::endl; 
