...
SC_MODULE(testbench)
{
  ...
  void run()
  {
    ...
    fout << "    NVDLA_PDP_S_CONSUMER => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_s_consumer << std::endl; 
     ...
     fout << "    NVDLA_PDP_D_DATA_CUBE_IN_WIDTH => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_in_width << std::endl; 
      fout << "    NVDLA_PDP_D_DATA_CUBE_IN_HEIGHT => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_in_height << std::endl; 
     fout << "    NVDLA_PDP_D_DATA_CUBE_IN_CHANNEL => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_in_channel << std::endl; 
   
     fout << "    NVDLA_PDP_D_DATA_CUBE_OUT_WIDTH => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_out_width << std::endl; 
     fout << "    NVDLA_PDP_D_DATA_CUBE_OUT_HEIGHT => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_out_height << std::endl; 
     fout << "    NVDLA_PDP_D_DATA_CUBE_OUT_CHANNEL => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_cube_out_channel << std::endl;
   
    fout << "    NVDLA_PDP_POOLING_METHOD => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pooling_method << std::endl; 
     fout << "    NVDLA_PDP_FLYING_MODE => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_flying_mode << std::endl; 
     fout << "    NVDLA_PDP_SPLIT_NUM => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_split_num << std::endl; 
   
     fout << "    NVDLA_PDP_D_NAN_FLUSH_TO_ZERO => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_nan_to_zero << std::endl; 

     fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_IN_FIRST => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_in_first << std::endl; 
     fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_IN_MID => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_in_mid << std::endl; 
     fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_IN_LAST => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_in_last << std::endl; 

     fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_OUT_FIRST => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_out_first << std::endl; 
    fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_OUT_MID => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_out_mid << std::endl; 
    fout << "    NVDLA_PDP_D_PARTIAL_WIDTH_OUT_LAST => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_partial_width_out_last << std::endl; 
    ...
    fout << "    NVDLA_PDP_D_KERNEL_STRIDE_HEIGHT => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_kernel_stride_height << std::endl;     
    fout << "    NVDLA_PDP_D_KERNEL_STRIDE_WIDTH => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_kernel_stride_width << std::endl; 

    fout << "    NVDLA_PDP_D_RECIP_KERNEL_WIDTH => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_recip_kernel_width << std::endl; 

    fout << "    NVDLA_PDP_D_RECIP_KERNEL_HEIGHT => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_recip_kernel_height << std::endl; 

  fout << "    NVDLA_PDP_D_PAD_LEFT => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_left << std::endl; 
    fout << "    NVDLA_PDP_D_PAD_TOP => " << std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_top << std::endl; 
    fout << "    NVDLA_PDP_D_PAD_RIGHT => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_right << std::endl;     
    fout << "    NVDLA_PDP_D_PAD_BOTTOM => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_bottom << std::endl; 

        fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_1_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_1x << std::endl; 
  
    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_2_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_2x << std::endl; 

    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_3_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_3x << std::endl; 

    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_4_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_4x << std::endl; 

    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_5_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_5x << std::endl; 

    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_6_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_6x << std::endl; 

    fout << "    NVDLA_PDP_D_POOLING_PADDING_VALUE_7_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_pad_value_7x << std::endl; 

    fout << "    NVDLA_PDP_D_SRC_BASE_ADDR_LOW => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_src_base_addr_low << std::endl; 

        fout << "    NVDLA_PDP_D_SRC_BASE_ADDR_HIGH => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_src_base_addr_high << std::endl; 

        fout << "    NVDLA_PDP_D_SRC_LINE_STRIDE => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_src_line_stride << std::endl; 

        fout << "    NVDLA_PDP_D_SRC_SURFACE_STRIDE => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_src_surface_stride << std::endl; 

        fout << "    NVDLA_PDP_D_DST_BASE_ADDR_LOW => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dst_base_addr_low << std::endl; 

        fout << "    NVDLA_PDP_D_DST_BASE_ADDR_HIGH => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dst_base_addr_high << std::endl; 

        fout << "    NVDLA_PDP_D_DST_LINE_STRIDE => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dst_line_stride << std::endl; 

        fout << "    NVDLA_PDP_D_DST_SURFACE_STRIDE => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dst_surface_stride << std::endl; 

        fout << "    NVDLA_PDP_D_DST_RAM_CFG => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dst_ram_type << std::endl; 

        fout << "    NVDLA_PDP_D_DATA_FORMAT => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_input_data << std::endl; 

        fout << "    NVDLA_PDP_D_INF_INPUT_NUM => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_inf_input_num << std::endl; 

        fout << "    NVDLA_PDP_D_NAN_INPUT_NUM => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_nan_input_num << std::endl; 

        fout << "    NVDLA_PDP_D_NAN_OUTPUT_NUM => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_nan_output_num << std::endl; 

        fout << "    NVDLA_PDP_D_PERF_ENABLE => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_dma_en << std::endl; 

        fout << "    NVDLA_PDP_D_PERF_WRITE_STALL => "<< std::dec << (sc_dt::sc_bigint<16>)pdp_inst.pdp_group0_pdp_d_perf_write_stall << std::endl; 
